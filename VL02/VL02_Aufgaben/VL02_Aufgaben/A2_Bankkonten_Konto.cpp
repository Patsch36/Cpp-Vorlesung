...
std::string A2_Bankkonten_Konto::kontotypToText()
{
	switch (this->_typ)
	{
...
A2_Bankkonten_Konto::A2_Bankkonten_Konto(kontotyp typ, int blz, float startbetrag, float zinssatz) :
...
void A2_Bankkonten_Konto::readValues()
{
...
void A2_Bankkonten_Konto::addMoney(float betrag)
{
	if (betrag <= 0)
